          ...
          <div
            ...
            <div class="content-3-6" style="font-family: 'Poppins', sans-serif">
                <form class="mt-6" action="index.php" method="POST" >
                    <div class="mb-7">
                      <label class="block text-lg font-medium text-medium-white">Nomor ID Meter/Pelanggan</label>
                      <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                        <input type="text" name="NomerID" id="" 
                          class="w-full focus:outline-none text-base font-light bg-medium-black-2 text-center" value="<?=$row['noid'];?>" readonly />
                      </div>
                    </div>
