        ...
        <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
          ...
          <div
            ...
            <div class="content-3-6" style="font-family: 'Poppins', sans-serif">
                <form class="mt-6" action="updatekonfirmasipulsa.php" method="POST" >
                    ...
                    <div class="mb-7">
                      ...
                      <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                        <input type="text" name="" id="" 
                          class="w-full focus:outline-none text-base font-light bg-medium-black-2 text-center" value="<?=$NomerHp.substr(str_shuffle($permitted_chars), 0, 4).'';?>" readonly />
                      </div>
                    </div>
                    <div class="mb-7">
