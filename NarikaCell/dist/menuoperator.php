      ...
      <div>
        ...
        <div class="md:container md:mx-auto items-center text-center">
            <h1 class="title-font  font-semibold sm:leading-tight">
                Silahkan Pilih Operator Anda<br class="lg:block hidden" />
              </h1>
        </div>
        <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
          ...
          <div
            ...
            <form class="mt-6" action="updateopt.php" method="POST" x-data="{ show: false }">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/smartfren.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="OPT" id="" value="Smartfren"
                        ...
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-3 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/Three.jpeg"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="OPT" id="" value="Tri"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            ...
                            <div class="flex w-full px-5 py-2 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/axis.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="OPT" id="" value="Axis"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-6 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/xl.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="OPT" id="" value="XL"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/telkomsel.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="OPT" id="" value="Telkomsel"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/indosat.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="OPT" id="" value="Indosat"
