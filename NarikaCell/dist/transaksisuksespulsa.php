...
$sql = "SELECT * FROM pulsa WHERE nomer = '$NomerHp'";
      ...
      <div>
        <div class="md:container md:mx-auto items-center text-center">
            <h1 class="title-font  font-semibold sm:leading-tight">
                Transaksi Sukses!<br class="lg:block hidden" />
              </h1>
        </div>
          ...
          <div
            ...
            <div class="content-3-6" style="font-family: 'Poppins', sans-serif">
                <form class="mt-6" action="index.php" method="POST" >
                    <div class="mb-7">
                      <label class="block text-lg font-medium text-medium-white">Nomor Handphone</label>
                      <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                        <input type="text" name="NomerHp" id="" 
                          class="w-full focus:outline-none text-base font-light bg-medium-black-2 text-center" value="<?=$row['nomer'];?>" readonly />
                      </div>
                    </div>
                    <div class="mb-7">
                      <label class="block text-lg font-medium text-medium-white">Operator</label>
                      <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                        <input type="text" name="NomerHp" id="" 
                          class="w-full focus:outline-none text-base font-light bg-medium-black-2 text-center" value="<?=$row['operator'];?>" readonly />
                      </div>
                    </div>
                    <div class="mb-7">
                      <label class="block text-lg font-medium text-medium-white">Nominal</label>
                      <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                        <input type="text" name="NomerHp" id="" 
                          class="w-full focus:outline-none text-base font-light bg-medium-black-2 text-center" value="<?=$nominul;?>" readonly />
                      </div>
                    </div>
                    <div class="mb-7">
