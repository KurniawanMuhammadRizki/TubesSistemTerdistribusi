      ...
      <div>
        <div class="md:container md:mx-auto items-center text-center">
            <h1 class="title-font  font-semibold sm:leading-tight">
                Silahkan Pilih Metode Pembayaran Anda<br class="lg:block hidden" />
              </h1>
        </div>
        <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
          ...
          <div
            ...
            <div class="content-3-6" style="font-family: 'Poppins', sans-serif">
                <form class="mt-6" action="updatepembayarantoken.php" method="POST" x-data="{ show: false }">
                <input type="hidden" name="NomerID" value="<?=$NomerID;?>">
                    <div class="grid grid-cols-3 gap-4">
                            
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-5 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/bca.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="PEM" id="" value="Transfer via BCA"
                        ...
                        <div class="mb-1">
                            ...
                            <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/bni.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="PEM" id="" value="Transfer via BNI"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-5 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/bri.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="PEM" id="" value="Transfer via BRI"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            ...
                            <div class="flex w-full px-5 py-2 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/mandiri.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="PEM" id="" value="Transfer via MANDIRI"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-2 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/indomaret.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="PEM" id="" value="Pembayaran INDOMARET"
                                class="w-full  text-base font-light bg-medium-black-2"  />
                            </div>
                            </label>
                        </div>
                        <div class="mb-1">
                            <label >
                            <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                                <img src="../src/img/alfamart.png"
                                alt="" width="80px" height="80px"/>
                                <input type="radio" name="PEM" id="" value="Pembayaran ALFAMART"
